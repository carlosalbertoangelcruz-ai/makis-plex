...
const BASE_DATOS_MENU = {
  ...
  14: { nombre: "Chicha Morada (1L)", precio: 12.00 },
  15: { nombre: "Gaseosa Personal", precio: 6.00 }
};

const correlativoBoleta =
Math.floor(200000 + Math.random() * 700000);
...
document.getElementById("mensaje-mesa").innerText=
`📍 Mesa ${mesa} lista para ordenar.`;

document.getElementById("boleta-mesa-num").innerText=
mesa;
...
document.getElementById("boleta-items-lista");
...
const cantidad=
parseInt(document.getElementById(`cant-${i}`).value)||1;
...
// Notas
const notas=
document.getElementById("notas-cocina")
.value.trim();
...
document.getElementById(
"boleta-numero"
).innerText=correlativoBoleta;

document.getElementById(
"boleta-mesa-num"
).innerText=inputMesa.value;
